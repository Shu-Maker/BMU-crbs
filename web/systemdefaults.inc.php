 ...
 *********************************/
$mrbs_admin = "BMU-Administrator";
$mrbs_admin_email = "shubham.verma.14cse@bml.edu.in";
...
// $mrbs_admin_email = 'Booking System <shubham.verma.14cse@bml.edu.in>';
// if the name section has any "peculiar" characters in it, you will need
// to put the name in double quotes, e.g.:
// $mrbs_admin_email = '"Verma, Shubham" <shubham.verma.14cse@bml.edu.in>';

// The company name is mandatory.   It is used in the header and also for email notifications.
// The company logo, additional information and URL are all optional.

$mrbs_company = "BMU- Conference Room Booking Service";   // This line must always be uncommented ($mrbs_company is used in various places)

// Uncomment this next line to use a logo instead of text for your organisation in the header
$mrbs_company_logo = "images/images.png";    // name of your logo file.   This example assumes it is in the MRBS directory


// Uncomment this next line for supplementary information after your company name or logo
//$mrbs_company_more_info = "	BMU- Conference Room Booking Service";  // e.g. "XYZ Department"

// Uncomment this next line to have a link to your organisation in the header
$mrbs_company_url = "http://www.bml.edu.in/";
...
// Set the email address of the From field. Default is 'shubham.verma.14cse@bml.edu.in'
$mail_settings['from'] = 'shubham.verma.14cse@bml.edu.in';
...
// Set the recipient email. Default is 'shubham.verma.14cse@bml.edu.in'. You can define
// more than one recipient like this "john@doe.com,scott@tiger.com"
$mail_settings['recipients'] = 'shubham.verma.14cse@bml.edu.in';
...
//
$vocab_override['en']['mrbs'] = "Making room booking simpler!";
//
